...
return(<nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,borderBottom:"1px solid rgba(200,98,26,"+(scrolled?"0.22":"0.10")+")",backgroundColor:scrolled?"rgba(10,4,1,0.88)":"rgba(10,4,1,0.55)",backdropFilter:"blur(14px)",transition:"all 0.4s ease",padding:"0 2rem"}}>
...
<span style={{fontFamily:"monospace",fontSize:"0.75rem",color:"#F0C040",letterSpacing:"0.15em",opacity:1,textShadow:"0 0 18px rgba(240,192,64,0.55)"}}>{pct}%</span>
</div>
