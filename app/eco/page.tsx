...
{grant.status==="pending"&&<div style={{display:"flex",gap:"0.75rem",alignItems:"center",flexWrap:"wrap",borderTop:"1px solid rgba(232,221,208,0.06)",paddingTop:"0.75rem"}}>
...
<button onClick={()=>act("approve")} disabled={actStatus==="sending"} style={{padding:"0.4rem 1rem",border:"1px solid rgba(212,160,60,0.5)",backgroundColor:"transparent",color:"rgba(212,160,60,0.8)",fontFamily:"monospace",fontSize:"0.6rem",letterSpacing:"0.15em",textTransform:"uppercase",cursor:"crosshair",transition:"all 0.3s ease"}}>Approve</button>
