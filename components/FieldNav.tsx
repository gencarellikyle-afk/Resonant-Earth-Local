...
return(<nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,borderBottom:"1px solid rgba(200,98,26,"+(scrolled?"0.22":"0.10")+")",backgroundColor:scrolled?"rgba(10,4,1,0.92)":"rgba(10,4,1,0.60)",backdropFilter:"blur(18px)",transition:"all 0.4s ease",padding:"0 2rem",boxShadow:scrolled?"0 1px 22px rgba(200,98,26,0.14)":"none"}}>
