...
return(<nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,borderBottom:"none",backgroundColor:scrolled?"rgba(10,4,1,0.92)":"rgba(10,4,1,0.60)",backdropFilter:"blur(18px)",transition:"all 0.4s ease",padding:"0 2rem",boxShadow:scrolled?"0 1px 22px rgba(200,98,26,0.14)":"none"}}><div style={{position:"absolute",bottom:0,left:0,height:"1px",width:pct+"%",background:"linear-gradient(to right, rgba(200,98,26,0.4), rgba(240,192,64,0.8), rgba(200,98,26,0.4))",transition:"width 1.4s ease",boxShadow:"0 0 8px rgba(240,192,64,0.4)"}}/><div style={{position:"absolute",bottom:0,left:0,right:0,height:"1px",backgroundColor:"rgba(200,98,26,0.10)"}}/>
...
<span style={{fontFamily:"monospace",fontSize:"0.72rem",color:"#F0C040",letterSpacing:"0.12em",opacity:1,textShadow:"0 0 18px rgba(240,192,64,0.55)"}}>{pct}% &middot; {stateLabel}</span>
</div>
<Link href="/apply" style={{padding:"0.48rem 1.3rem",border:"1px solid rgba(255,87,34,0.75)",backgroundColor:"rgba(255,87,34,0.12)",color:"#FF5722",fontFamily:"monospace",fontSize:"0.72rem",letterSpacing:"0.2em",textTransform:"uppercase",textDecoration:"none",transition:"all 0.3s ease",backdropFilter:"blur(4px)",cursor:"crosshair"}} onMouseEnter={e=>{e.currentTarget.style.backgroundColor="rgba(255,87,34,0.25)";e.currentTarget.style.borderColor="#FF5722";e.currentTarget.style.color="#FDF6EC";}} onMouseLeave={e=>{e.currentTarget.style.backgroundColor="rgba(255,87,34,0.12)";e.currentTarget.style.borderColor="rgba(255,87,34,0.75)";e.currentTarget.style.color="#FF5722";}}>Apply</Link>
</div>
</div>
</nav>);}
