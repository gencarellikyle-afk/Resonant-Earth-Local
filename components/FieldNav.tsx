...
return(<nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,borderBottom:"none",backgroundColor:scrolled?"rgba(2,4,8,0.92)":"rgba(2,4,8,0.60)",backdropFilter:"blur(18px)",transition:"all 0.4s ease",padding:"0 2rem",boxShadow:scrolled?"0 1px 22px rgba(13,71,161,0.14)":"none"}}><div style={{position:"absolute",bottom:0,left:0,height:"1px",width:pct+"%",background:"linear-gradient(to right, rgba(13,71,161,0.6), rgba(79,195,247,0.9), rgba(13,71,161,0.6))",transition:"width 1.4s ease",boxShadow:"0 0 8px rgba(79,195,247,0.5)"}}/><div style={{position:"absolute",bottom:0,left:0,right:0,height:"1px",backgroundColor:"rgba(13,71,161,0.10)"}}/>
